...
public class ViewBookFrame extends JDialog implements ActionListener, WindowListener { 
...
//		setResizable(false);
	...
	public ViewBookFrame(AdminBookFrame adminBookFrame, int width, int height, Book book) {
	...
	public ViewBookFrame(MemberBookFrame memberBookFrame, int width, int height, Book book) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(okBtn)) {
			if(adminBookFrame != null) {
				exitFrame(adminBookFrame);				
			} else if(memberBookFrame != null) {
				exitFrame(memberBookFrame);								
			}
		}
	}
