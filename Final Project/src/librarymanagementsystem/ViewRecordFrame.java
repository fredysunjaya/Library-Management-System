...
//		setResizable(false);
	...
	public ViewRecordFrame(AdminIssuedRecordsFrame adminIssuedFrame, int width, int height, IssuedBook issuedBook) {
	...
	public ViewRecordFrame(MemberIssuedRecordsFrame memberIssuedFrame, int width, int height, IssuedBook issuedBook) {
